...
/**
 * Class used to handle a PostgreSQL database. Note that some query methods are overridden as the SQL syntax is
 * different from other database types.
 *
 * @author Pyves
 *
 */
public class PostgreSQLDatabaseManager extends AbstractRemoteDatabaseManager {
	...
	public PostgreSQLDatabaseManager(@Named("main") YamlConfiguration mainConfig, Logger logger,
		...
		super(mainConfig, logger, databaseUpdater, "org.postgresql.Driver", "postgresql", databaseExecutor);
	}
